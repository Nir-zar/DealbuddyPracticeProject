      ...
      >
        {loading ? (
          ...
          <>
            ...
            {currentItemsLength == currentResponseTotalCount ? (
              <></>
            ) : (
              <>
                <Box
          ...
          <>
            <Grid xl={12} sx={{ ...allCenter, height: { xl: "10rem" } }}>
              <Typography
                sx={{ fontSize: theme.typography.h5.lg, fontWeight: "500" }}
              >
                No store available
              </Typography>
            </Grid>
...
export default OnlineStoreComponent;
